...
export function useTable() {
    ...
    const sortedCustomers = useMemo(() => filteredCustomers.toSorted((a, b) => {
    ...
    const paginatedCustomers = sortedCustomers.slice(startRow, startRow + recordsPerPage)
    ...
    return { tableProperties, sort, sortColumn, paginatedCustomers, sortDesc, page, nextPage, previousPage, pageCount }
}